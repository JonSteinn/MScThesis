...
The two fusion rules shown in \FigureRef{fig:fuseq} are an example of two equivalent nonbijective rules.  Combinatorial Exporation found the generating function of both right hand sides to be
\[
