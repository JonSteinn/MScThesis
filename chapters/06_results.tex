...
\]
seen in \FigureRef{fig:wordtiling}.
\begin{figure}[ht!]
    \centering
...
The inputs and outputs of length $4$ for the bijection are shown in \TableRef{tab:ssexamp} and it seems to agree with the \citeauthor{simionandschmidt} bijection in \cite{simionandschmidt} which we leave as an open problem in Conjecture~\ref{con:ss}.
