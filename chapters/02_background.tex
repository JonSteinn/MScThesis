...
\]
Now we have our specification, a system of rules with each class on the left at most once, defining an unambiguous formal grammar as shown with a tree representation in \FigureRef{fig:gridtree}.
