...
In \ChapterRef{ch:parallel} we define a criteria that must hold so a bijection can be constructed and in \ChapterRef{ch:pbijection} we define the resulting bijection. The search method for bijections is detailed in \ChapterRef{ch:search}. We state notable successes and shortcomings in \ChapterRef{ch:results} and reflect on our work in \ChapterRef{ch:conclusion}.
