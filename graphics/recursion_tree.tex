...
\begin{tikzpicture}[scale=0.5, baseline=(current bounding box.center)]
			\base{#1}{#2}
			\draw (3.5,1.5) node {$\textsf{rextend}(13) = 136$};
...
\begin{tikzpicture}[scale=0.8, every node/.style={scale=0.8}]
    ...
    \node (lvl41) at (-2,-13) {\lrecnode{252}{1368}{A\overset{\sqcup}{\rightarrow}\mathbf{B}\overset{\times}{\rightarrow}A\overset{\sqcup}{\rightarrow}\mathbf{B}}{E\overset{\sqcup}{\rightarrow}\mathbf{F}\overset{\times}{\rightarrow}G\overset{\idop}{\rightarrow}H\overset{\sqcup}{\rightarrow}\mathbf{F}}};
