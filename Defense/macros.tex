...
\definecolor{brownish}{RGB}{59,42,35}
\definecolor{slideback}{RGB}{250,250,250}
...
\newcommand{\viewborder}{\draw [blue] (current bounding box.north west) rectangle (current bounding box.south east);}

\newcommand{\circover}[4]{\fill<#4>[white] (#1) circle (#2); \draw<#4> (#1) circle (#2) node {#3};}